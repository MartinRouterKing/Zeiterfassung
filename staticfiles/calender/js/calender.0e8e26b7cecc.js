...
$('.fc-myCustomButton-button btn btn-primary').attr("data-toggle", "modal");
$('.fc-myCustomButton-button btn btn-primary').attr("data-target","#myModal");
console.log($('.fc-myCustomButton-button btn btn-primary'));
