  ...
  $('#calendar').fullCalendar({
    ...
    eventRender: function(event, element, view) {
            ...
            element.popover({
                    ...
                    title: "" + event.title + "",
                    trigger: "click",
                    content: "<div style='color: white;' id= '" + event._id + "cont' >Notizen: <textarea class='form-control' id='" + event._id + "'>" + event.note + " </textarea><button style='margin-top: 10px; margin-bottom: 10px; float: right;' type='button' id='pop_save' class='btn btn-primary'>Speichern</button></div",
                    });
    },
    ...
    eventMouseover: function( event, jsEvent, view ) {
           ...
           $(document).one('click', '#pop_save', function(){
